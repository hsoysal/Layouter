...
class LayoutAlignmentTests: XCTestCase {
    ...
    func testAlignHorizontal() {
        ...
        view1.alignHorizontally(with: view2, view3)
    ...
    /// func alignHorizontally(with views: UIView..., constant: CGFloat = 0, option: SizeOption = .equal(1000)) -> UIView
    func testAlignHorizontalWithOffset() {
        view1.top(offset: 100)
            .left(offset: 100)
            .size(equals: 100)
            .alignTops(with: view2, view3)
        ...
        view1.alignHorizontally(with: view2, view3, constant: 20)
    ...
    /// func alignHorizontally(with views: UIView..., constant: CGFloat = 0, option: SizeOption = .equal(1000)) -> UIView
    func testAlignHorizontalWithOption() {
        view1.top(offset: 100)
            .left(offset: 100)
            .size(equals: 100)
            .alignTops(with: view2, view3)
        ...
        view1.alignHorizontally(with: view2, view3, constant: 20, option: .equal(998))
        view1.alignHorizontally(with: view2, view3, constant: 40, option: .equal(999))
    ...
    /// func alignHorizontally(with views: UIView..., constant: CGFloat = 0, option: SizeOption = .equal(1000)) -> UIView
    func testAlignHorizontalWithOptionGrater() {
        view1.top(offset: 100)
            .left(offset: 100)
            .size(equals: 100)
            .alignTops(with: view2, view3)
        ...
        view1.alignHorizontally(with: view2, view3, constant: 20, option: .equal(998))
        view1.alignHorizontally(with: view2, view3, constant: 40, option: .equalOrGrater(999))
    ...
    /// func alignHorizontally(with views: UIView..., constant: CGFloat = 0, option: SizeOption = .equal(1000)) -> UIView
    func testAlignHorizontalWithOptionLess() {
        view1.top(offset: 100)
            .left(offset: 100)
            .size(equals: 100)
            .alignTops(with: view2, view3)
        ...
        view1.alignHorizontally(with: view2, view3, constant: 40, option: .equal(998))
        view1.alignHorizontally(with: view2, view3, constant: 20, option: .equalOrless(999))
    ...
    func testAlignVertical() {
        ...
        view1.alignVertically(with: view2, view3)
    ...
    /// func alignHorizontally(with views: UIView..., constant: CGFloat = 0, option: SizeOption = .equal(1000)) -> UIView
    func testAlignVerticalWithOffset() {
        view1.top(offset: 100)
            .left(offset: 100)
            .size(equals: 100)
            .alignLefts(with: view2, view3)
        ...
        view1.alignVertically(with: view2, view3, constant: 20)
    ...
    /// func alignHorizontally(with views: UIView..., constant: CGFloat = 0, option: SizeOption = .equal(1000)) -> UIView
    func testAlignVerticalWithOption() {
        view1.top(offset: 100)
            .left(offset: 100)
            .size(equals: 100)
            .alignLefts(with: view2, view3)
        ...
        view1.alignVertically(with: view2, view3, constant: 20, option: .equal(998))
        view1.alignVertically(with: view2, view3, constant: 40, option: .equal(999))
    ...
    /// func alignHorizontally(with views: UIView..., constant: CGFloat = 0, option: SizeOption = .equal(1000)) -> UIView
    func testAlignVerticalWithOptionGrater() {
        view1.top(offset: 100)
            .left(offset: 100)
            .size(equals: 100)
            .alignLefts(with: view2, view3)
        ...
        view1.alignVertically(with: view2, view3, constant: 20, option: .equal(998))
        view1.alignVertically(with: view2, view3, constant: 40, option: .equalOrGrater(999))
    ...
    /// func alignHorizontally(with views: UIView..., constant: CGFloat = 0, option: SizeOption = .equal(1000)) -> UIView
    func testAlignVerticalWithOptionLess() {
        view1.top(offset: 100)
            .left(offset: 100)
            .size(equals: 100)
            .alignLefts(with: view2, view3)
        ...
        view1.alignVertically(with: view2, view3, constant: 40, option: .equal(998))
        view1.alignVertically(with: view2, view3, constant: 20, option: .equalOrless(999))
